...
public interface BeerRepository extends JpaRepository<Beer, UUID> {
    Page<Beer> findByBeerNameContainingAndBeerStyleIgnoreCase(String beerName, String beerStyle, Pageable pageInfo);
    Page<Beer> findByBeerNameLike(String beerName, Pageable pageInfo);
    Page<Beer> findByBeerStyle(String beerStyle, Pageable pageInfo);
    Page<Beer> findByBeerNameContainingIgnoreCase(String beerName, Pageable pageInfo);
